...
export default function CreateAdmin() {
  ...
  const onSubmit = async (userData: ISignUpData) => {
    ...
    await postUserData(signUpData)
      ...
      .then((payload) => {
        console.log(payload);
        toast.success("successfully admin account Created");
  ...
  return (
    <div className="  mt-5 flex items-center justify-center ">
      <Form
        ...
        register={register}
      >
        <h1 className="text-center text-2xl text-orange-600 ">Create Admin</h1>
        <div className="  grid justify-center ">
          ...
          <div className=" ">
            <Input
              className="border  text-black lg:w-96 extraSm:w-60  border-slate-400 rounded p-2"
              name="firstName"
              type="text"
        ...
        <div className="  grid justify-center ">
          ...
          <div className="">
            <Input
              className="border lg:w-96 text-black extraSm:w-60   border-slate-400 rounded p-2"
