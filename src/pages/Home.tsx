  ...
  return (
    <LazyMotion features={domAnimation}>
      <div className="relative">
        ...
        <Banner />
        <div className="  ">
          <h1 className="text-center text-4xl my-5 ">Top Available Service</h1>
          <div className="  h- w-3/4 mx-auto grid xl:grid-cols-3   gap-16   lg:grid-cols-2 md:grid-cols-1 extraSm:grid-cols-1">
          ...
          <div>
            <h1 className="text-center text-4xl my-5 ">Top Upcoming Service</h1>
            <div className="   bottom-0 w-3/4 mx-auto grid xl:grid-cols-3  gap-16   lg:grid-cols-2 md:grid-cols-1 extraSm:grid-cols-1 mb-10">
